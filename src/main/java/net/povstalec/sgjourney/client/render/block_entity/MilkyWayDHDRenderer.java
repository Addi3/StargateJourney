...
public class MilkyWayDHDRenderer extends AbstractDHDRenderer<AbstractDHDEntity>
{
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(
            StargateJourney.MODID, "textures/entity/dhd/milkyway_dhd.png");

    private final AbstractDHDModel model;

    public MilkyWayDHDRenderer(BlockEntityRendererProvider.Context context)
    {
        super(context);
